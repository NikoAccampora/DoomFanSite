...
<body>
    <center>
    <h1 style="font-size: 200%">CREATE NEW WEAPON</h1>
		<hr>
		<p style="font-size:125%;">Engineer more ways to kill</p>
...
<!--MESSAGE SESSION DISPLAY AREA DECLARATION-->
    ...
    <form action="../controller/createweapon.controller.php" method="post">
            ...
            <br>
            <label class="form-label" for="weapon_damage">Weapon Damage?</label>
