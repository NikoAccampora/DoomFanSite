...
<body>
    <center>
    <h1 style="font-size: 200%">CREATE NEW MONSTER</h1>
		<hr>
		<p style="font-size:125%;">A new threat arises?</p>
...
<!--MESSAGE SESSION DISPLAY AREA DECLARATION-->
    ...
    <form action="../controller/createmonster.controller.php" method="post">
